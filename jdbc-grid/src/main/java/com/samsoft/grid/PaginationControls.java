...
public class PaginationControls extends HorizontalLayout {
    ...
    public PaginationControls() {
        ...
        setWidthFull();
        addToStart(new Span());
        addToEnd(createPageSizeField(), firstPageButton, goToPreviousPageButton, currentPageLabel, goToNextPageButton, lastPageButton);
    }
    ...
    void recalculatePageCount(int totalItemCount) {
