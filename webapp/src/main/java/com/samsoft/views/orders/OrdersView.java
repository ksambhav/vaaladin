package com.samsoft.views.orders;

import com.samsoft.data.SamplePerson;
import com.samsoft.services.SamplePersonService;
...
@PageTitle("Orders")
@Route("orders")
@Menu(order = 3, icon = LineAwesomeIconUrl.ACQUISITIONS_INCORPORATED)
@Uses(Icon.class)
@PermitAll
public class OrdersView extends Div {
    ...
    public OrdersView(SamplePersonService SamplePersonService) {
